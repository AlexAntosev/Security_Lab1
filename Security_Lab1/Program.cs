...
namespace Security_Lab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var result = XorDecoder.Decrypt(textToDecode);
            
            Console.WriteLine(result.ToString());
            
            //Multiple xor cipher
            var secondTextToDecode =
            ...
            var binary = RepeatingXorDecoder.FromHexToChars(secondTextToDecode);
            var secondResult = RepeatingXorDecoder.AttackRepeatingXor(binary);
