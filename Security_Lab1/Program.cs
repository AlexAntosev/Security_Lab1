...
namespace Security_Lab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var decryptedSingleXorCipher = SingleByteXorAttacker.AttackBytes(singleXorCipher);
            var result = Analyzer.AnalyzeSingleResult(new List<Dictionary<string, string>> {decryptedSingleXorCipher},
                Encoding.ASCII.GetBytes(singleXorCipher));
            ...
            var decryptedRepeatingKeyXorCipher = RepeatingXorDecoder.Attack(repeatingKeyXorCipher);
            
            Console.WriteLine(decryptedRepeatingKeyXorCipher);
        }
    }
}